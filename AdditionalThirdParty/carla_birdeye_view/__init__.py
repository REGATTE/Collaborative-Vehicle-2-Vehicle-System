...
RGB_BY_MASK = {
    BirdViewMasks.EGO_VEHICLE:RGB.GREEN,
    BirdViewMasks.SMART_VEHICLES:RGB.SKY_BLUE,
...
class BirdViewProducer:
    ...
    def _render_actors_masks(
        ...
        masks[BirdViewMasks.VEHICLES.value], masks[BirdViewMasks.SMART_VEHICLES.value], masks[BirdViewMasks.EGO_VEHICLE.value] = self.masks_generator.vehicles_mask(
